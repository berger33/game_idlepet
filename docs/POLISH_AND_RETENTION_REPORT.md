...
- Save v3 com migração sequencial v0→v1→v2→v3.
- Nível de jogador e XP: Good concede 10 XP, Perfect 15 XP.
- Próximo nível: `40 + (nível−1)×20`; level-up concede `20 + nível×5` moedas.
- Marcos continuam espaçados: primeiro upgrade em 2–3 serviços, tosa no terceiro ciclo, Luna após 3 serviços, Bia após 8, estabelecimento de bairro a 500 moedas.
