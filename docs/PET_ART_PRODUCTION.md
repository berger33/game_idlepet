...
A ferramenta de geração disponível limita cada turno a dez imagens. Restam 40 sprites, organizados em quatro lotes de dez, sem redução de escopo:

- Lote 2: Bob, Neve, Sol, Café, Jade, Pitanga, Bento, Azul, Paçoca, Lua.
