...
| `pets/*.png` lotes 1–3 (30) | 20 pets anteriores + Kiko, Sushi, Cacau, Juma, Tupã, Aurora, Gaia, Nox, Rio e Estrela | ilustrações originais geradas e recortadas/curadas para este projeto | 512×512 RGBA | raças individualizadas; nenhuma imagem de referência foi incorporada |
| 20 pets restantes | runtime temporário | desenho vetorial procedural original em GDScript | escalável | fallback preservado até os dois lotes finais de arte |
