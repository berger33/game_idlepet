...
| `stations/station_bathtub_rustic.png` | banho, capítulo 1 (quintal): tina rústica de madeira e metal | ilustração original gerada e recortada/curada (tools/normalize_station_art.py) | 440×324 RGBA | aro frontal fatiado em runtime para ocluir as patas do pet; sem texto |
| `stations/station_bathtub_spa.png` | banho, capítulo 2+: banheira de porcelana com pés dourados | ilustração original gerada e recortada/curada (tools/normalize_station_art.py) | 440×284 RGBA | torneira/tiqueta atrás do pet; fatia frontal idem rústica |
