...
Playable Core em **Godot 4.x**, portrait e offline-first. Sirva Caramelo, esfregue para produzir espuma, finalize na faixa Perfect, receba review/moedas e melhore a banheira. Toda arte e SFX atuais são procedurais e sem dependência externa.
...
4. Save fica em `user://save.dat`, com três backups.
...
## Status
Milestone **Fundação + Playable Core implementada; validação runtime/device e playtest pendentes**. Não escalar conteúdo antes do gate humano descrito em `docs/ROADMAP.md`. Leia `docs/FINAL_REPORT.md` para riscos conhecidos.
